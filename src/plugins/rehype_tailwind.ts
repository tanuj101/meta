...
const TAG_UTIL_MAP = {
  common: {
    ...
    li: tw`marker:text-primary gfm-done:marker:text-green gfm-done:marker:content-["✓_"] gfm-todo:marker:content-["▢_"] [&.task-list-item_input]:appearance-none [&[id^="user-content-fn"]_p]:my-0`,
  ...
  page: {
    h1: tw`text-3xl text-primary sm:text-5xl`,
    h2: tw`hhr text-primary`,
    h3: tw`hhrs text-primary`,
  } as Record<string, string>,
  post: {
    h2: tw`text-2xl`,
    h3: tw`text-xl`,
