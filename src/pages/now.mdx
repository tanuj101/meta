...
- As a Frontend Engineer on
  [Almada](https://alm-live.kwalee.com/), an [ad mediation solution](https://www.is.com/glossary/ad-mediation/) for
...
- [`meta`](https://pls.cli.rs), a prettier and powerful `ls(1)` for the pros. I
